...
const SocialMediaCard = () => {
  return (
    <div className="card">
      ...
      <div className="icons">
      <a className="github" href="https://github.com/thabhelo" target='_blank'>
          <svg
          ...
          >
            <path
              ...
              stroke-width="2"
              stroke="currentColor"
              d="M12 2C6.48 2 2 6.48 2 12C2 16.42 4.87 20.17 8.84 21.5C9.34 21.58 9.5 21.27 9.5 21C9.5 20.77 9.49 20.19 9.49 19.39C6.73 19.91 6.14 18.36 6.14 18.36C5.73 17.28 5.12 17 5.12 17C4.3 16.5 5.18 16.51 5.18 16.51C6.08 16.57 6.54 17.5 6.54 17.5C7.34 18.87 8.68 18.5 9.17 18.27C9.25 17.64 9.5 17.22 9.77 17C7.12 16.73 4.34 15.73 4.34 11.5C4.34 10.32 4.76 9.38 5.5 8.68C5.38 8.42 5.04 7.21 5.62 5.54C5.62 5.54 6.5 5.25 9.5 7C10.29 6.77 11.15 6.65 12 6.65C12.85 6.65 13.71 6.77 14.5 7C17.5 5.25 18.38 5.54 18.38 5.54C18.96 7.21 18.62 8.42 18.5 8.68C19.24 9.38 19.66 10.32 19.66 11.5C19.66 15.74 16.88 16.73 14.23 17C14.62 17.34 15 18.03 15 19.03C15 20.39 15 21.27 15 21C15 21.27 15.16 21.58 15.66 21.5C19.63 20.17 22.5 16.42 22.5 12C22.5 6.48 18.02 2 12 2Z"
            ></path>
          </svg>
        </a>
        <a className="linkedin" href="https://linkedin.com/in/thabhelo" target='_blank'>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          >
            <path
              ...
              stroke-width="2"
              stroke="currentColor"
              d="M16 8C17.1 8 18 8.9 18 10V16H15V10H13V16H10V10H8V16H5V10C5 8.9 5.9 8 7 8H16ZM4 4C4 4.55 4.45 5 5 5C5.55 5 6 4.55 6 4C6 3.45 5.55 3 5 3C4.45 3 4 3.45 4 4ZM4 6H6V16H4V6Z"
            ></path>
          </svg>
        </a>
      
        <a className="instagram" href="https://www.instagram.com/thabhelo_tabs/" target='_blank'>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 25"
        ...
        <a className="x" href="https://twitter.com/thabhelo_tabs" target='_blank'>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
