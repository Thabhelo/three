  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/20">
      ...
      <motion.nav
        ...
        className="relative z-50 w-full py-6 px-4 bg-white/80 backdrop-blur-lg border-b border-gray-100"
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <motion.a
            href="/dreamsprint"
            className="flex items-center space-x-3 text-2xl font-black text-gray-900 hover:text-blue-600 transition-colors group"
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <motion.div 
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <h4 className="text-lg font-semibold text-purple-400">Timeline</h4>
                <div className="space-y-2 text-gray-300">
              ...
              <motion.div 
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <h4 className="text-lg font-semibold text-cyan-400">What to Expect</h4>
                <div className="space-y-2 text-gray-300">
            ...
            <motion.p
              className="text-gray-400 text-sm leading-relaxed max-w-3xl mx-auto"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
